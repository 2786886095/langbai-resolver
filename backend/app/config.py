...
class Settings:
    ...
    update_version: str = "1.0.0"
    update_notes: str = "langbai解析首个公开版本"
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            in {"1", "true", "yes", "on"},
            update_version=os.getenv("LANGBAI_UPDATE_VERSION", "1.0.0").strip(),
            update_notes=os.getenv(
                "LANGBAI_UPDATE_NOTES", "langbai解析首个公开版本"
            ).strip(),
