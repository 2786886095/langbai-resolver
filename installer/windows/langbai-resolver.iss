...
#define AppExecutable "media_harbor.exe"
...
[Icons]
Name: "{group}\langbai解析"; Filename: "{app}\{#AppExecutable}"
Name: "{group}\卸载 langbai解析"; Filename: "{uninstallexe}"
Name: "{autodesktop}\langbai解析"; Filename: "{app}\{#AppExecutable}"; Tasks: desktopicon
